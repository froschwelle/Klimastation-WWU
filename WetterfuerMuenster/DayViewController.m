...
- (void)viewDidLoad
{
    ...
    self.maxTemperaturLabel.text = [NSString stringWithFormat:@"%1.1f °C",self.data.maxTemperaturLabel];
    self.minTemperaturLabel.text = [NSString stringWithFormat:@"%1.1f °C",self.data.minTemperaturLabel];
